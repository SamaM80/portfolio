...
import { Instagram, Linkedin, Mail as MailIcon, MapPin, Phone, Send, Twitch, Twitter } from "lucide-react";
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <a
                                        href="mailto:sama.m.fashami@gmail.com"
                                        className="text-muted-foreground hover:text-primary transition-colors">
                                        sama.m.fashami@gmail.com
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="pt-8">
                            ...
                            <div className="flex space-x-4 justify-center">
                                <a 
                                    href="https://linkedin.com/in/sama-mirzaee-542b601a8" 
                                    target="_blank" 
